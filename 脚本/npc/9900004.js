...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#v1112005#本服设定经验倍率1 爆率1 金钱1 ，全力杜绝外挂等程序影响游戏的公平性 如果一旦发现请立即向GM举报!\r\n"
        //    text += "#d角色名称：#b" + cm.getName() + "#k#n\t  #b当前在线时间：#r" + cm.getGamePoints() + "分钟#k#n\r\n"
         //   text += "#d点卷余额：#b" + cm.getPlayer().getCSPoints(1) + "#k#n\t#d  抵用卷余额：#b" + cm.getPlayer().getCSPoints(2) + "#k#n\r\n"
      //      text += "#d杀怪总数：#r" + cm.getPlayer().getsg() + " #k#n\r\n" 
            text += "" + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + ""
		
      text += "#L36##fEffect/CharacterEff/1022223/4/0#快捷传送#l#L27##fEffect/CharacterEff/1022223/4/0#副本传送#l#L29##fEffect/CharacterEff/1022223/4/0#BOSS重返#l\r\n\r\n"
	  text += "#L32##fEffect/CharacterEff/1022223/4/0#道具回收#l#L30##fEffect/CharacterEff/1022223/4/0#查询爆率#l#L7##fEffect/CharacterEff/1022223/4/0#查看排行#l\r\n\r\n"
      text += "#L51##fEffect/CharacterEff/1022223/4/0#每日狩猎#l#L52##fEffect/CharacterEff/1022223/4/0#每日副本#l#L53##fEffect/CharacterEff/1022223/4/0#每日BOSS#l\r\n\r\n"
	  text += "#L28##fEffect/CharacterEff/1022223/4/0#征集喇叭#l#L14##fEffect/CharacterEff/1022223/4/0#带人奖励#l#L2##fEffect/CharacterEff/1022223/4/0#在线奖励#l\r\n\r\n"
	  text += "#L39##fEffect/CharacterEff/1022223/4/0#精灵吊坠#l#L40##fEffect/CharacterEff/1022223/4/0#枫叶兑换#l#L41##fEffect/CharacterEff/1022223/4/0#中介兑换#l\r\n\r\n"
	  text += "#L13##fEffect/CharacterEff/1022223/4/0#豆屋娱乐#l#L22##fEffect/CharacterEff/1022223/4/0#快捷商店#l#L12##fEffect/CharacterEff/1022223/4/0#皇家大全#l\r\n\r\n"
	  text += "#L17##fEffect/CharacterEff/1022223/4/0#七星兑换#l#L23##fEffect/CharacterEff/1022223/4/0#七星注力#l#L9##fEffect/CharacterEff/1022223/4/0#装备出租#l\r\n\r\n"
	  
	  text += "" + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + 爱心 + ""
    //  text += "#L9##fEffect/CharacterEff/1022223/4/0#装备制造#l#L10##fEffect/CharacterEff/1022223/4/0#副本兑换#l#L11##fEffect/CharacterEff/1022223/4/0#金猪抽奖#l#L12##fEffect/CharacterEff/1022223/4/0#皇家大全#l\r\n"
       
     // text += "#L34##fEffect/CharacterEff/1022223/4/0#竞猜赌博#l#L14##fEffect/CharacterEff/1022223/4/0#带人奖励#l#L15##fEffect/CharacterEff/1022223/4/0#经验兑换#l#L16##fEffect/CharacterEff/1022223/4/0#杀怪兑换#l\r\n"

    //  text += "#L17##fEffect/CharacterEff/1022223/4/0#七星兑换#l#L18##fEffect/CharacterEff/1022223/4/0#开心钓鱼#l#L19##fEffect/CharacterEff/1022223/4/0#结婚传送#l#L20##fEffect/CharacterEff/1022223/4/0#家族系统#l\r\n\r\n"

     // text += "#L13##b#fEffect/CharacterEff/1022223/4/0#新点卷商城 new~#l#k\r\n\r\n"//#L21##fEffect/CharacterEff/1022223/4/0#快捷消耗商店#l #L23##fEffect/CharacterEff/1022223/4/0#七星注力系统#l
      
    //  text += "#L24##fEffect/CharacterEff/1022223/4/0#赌老虎机系统#l#L23##fEffect/CharacterEff/1022223/4/0#七星注力系统#l#L26##fEffect/CharacterEff/1022223/4/0#欢乐盖楼系统#l\r\n"
            
    //  text += "#L27##fEffect/CharacterEff/1022223/4/0#副本传送#l#L28##fEffect/CharacterEff/1022223/4/0#副本征集喇叭#l#L29##fEffect/CharacterEff/1022223/4/0#重返BOSS挑战#l\r\n"
           
  //    text += "#L30##fEffect/CharacterEff/1022223/4/0#查询地图爆率#l#L31##fEffect/CharacterEff/1022223/4/0#飞天猪蛋抽奖#l#L32##fEffect/CharacterEff/1022223/4/0#道具回收系统#l\r\n\r\n"
	    
   //   text += "#L36##fEffect/CharacterEff/1022223/4/0#快捷传送#l\t#L37##fEffect/CharacterEff/1022223/4/0#快速转职#l\t#L38##fEffect/CharacterEff/1022223/4/0#技能学习#l\r\n\r\n"
