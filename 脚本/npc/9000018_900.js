...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#e#d制作5000女血衣#v1052461#需要#v4011006#x100.#v4021007#x100.#v4021001#x100.#v4011004#x100.#v4011001#x100.#v4021003#x100.#v4021000#x100.#v4021002#x100.#v4021004#x100.#v4170005#x200.#v4170013#x200.#v4170002#x200.#v4011007#x30.#v4021009#x30.#v1051017#x1.#v4170016#x90.#v4031891#5000万.搜集好道具我就可以为您制作了.#l\r\n全属性+38.攻击38.魔法力50.桑拿为材料.合成后不计算加卷数量.\r\n"//3
            text += "#L1##r制作5000女血衣#l\r\n\r\n"//3
            cm.sendSimple(text);
        } else if (selection == 1) {
			//1
			//2
...
&& cm.haveItem(4021000,100) && cm.haveItem(4021002,100) && cm.haveItem(4021004,100) && cm.haveItem(4170005,200) && cm.haveItem(4170013,200) && cm.haveItem(4170002,200) && cm.haveItem(4011007,100) && cm.haveItem(4021009,100) && cm.haveItem(4170016,90) && cm.getMeso() > 50000000){
            ...
            cm.sendOk("制作成功！");
			cm.worldMessage(6,"玩家：["+cm.getName()+"]制作了[终极5000女血衣)]，装逼卖萌！无所不能！");
            cm.dispose();
			}else{
            cm.sendOk("您的材料不足！");
            cm.dispose();
