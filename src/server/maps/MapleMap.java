...
/*
        ...
        int mobpos = mob.getPosition().x, cmServerrate = ChannelServer.getInstance(channel).getMesoRate(), chServerrate = ChannelServer.getInstance(channel).getDropRate();
        IItem idrop;
        byte d = 1;
        ...
        final List<MonsterDropEntry> allDropEntry = mi.retrieveDrop(mob.getId());
        if (allDropEntry != null) {
            final List<MonsterDropEntry> dropEntry = new ArrayList<>(allDropEntry);
